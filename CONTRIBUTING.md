Contributing to Icolcoin Core
============================

The Icolcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Icolcoin Core project, and is not to be
confused with overall Icolcoin Network Protocol consensus changes.

Whether a pull request is merged into Icolcoin Core rests with the project merge
...
Patches that change Icolcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Icolcoin consensus, it must have been
...
The project leader is the release manager for each Icolcoin Core release.
