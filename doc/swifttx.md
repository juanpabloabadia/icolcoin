...
This mechanism has been integrated into Bitcore-Node-Icolcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Icolcoin-Project/insight-api-icolcoin#web-socket-api](https://github.com/Icolcoin-Project/insight-api-icolcoin#web-socket-api) 
* API: [https://github.com/Icolcoin-Project/insight-api-icolcoin#swifttx-transactions](https://github.com/Icolcoin-Project/insight-api-icolcoin#swifttx-transactions) 
...
By default, the Icolcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Icolcoin Core daemon:
