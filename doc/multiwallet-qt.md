...
In order to support loading of multiple wallets in icolcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is icolcoin.cpp.
...
Changes to icolcoin.cpp
----------------------
icolcoin.cpp is the entry point into icolcoin-qt, and as such, will require some minor modifications to provide hooks for
