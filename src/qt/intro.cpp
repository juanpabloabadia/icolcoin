...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Icolcoin Core"),
     ...
     * override -datadir in the icolcoin.conf file in the default data directory
     * (to be consistent with icolcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
