...
/* Icolcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Icolcoin"
#define QAPP_ORG_DOMAIN "icolcoin.org"
#define QAPP_APP_NAME_DEFAULT "Icolcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Icolcoin-Qt-testnet"
