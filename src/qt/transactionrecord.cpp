...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zicolTracker->HasMintTx(hash))) {
            //zICOL stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZICOL;
...
bool IsZICOLType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZICOL:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZICOL || type == TransactionRecord::MNReward) {
