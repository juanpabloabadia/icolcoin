...
/** Utility functions used by the Icolcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Icolcoin addresses in monospace font
...
// Parse "icolcoin:" URI into recipient object, return true on successful parsing
