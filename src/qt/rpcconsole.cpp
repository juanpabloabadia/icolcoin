                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzICOLPathCustom = GetArg("-zicolbackuppath", "");
    ...
    if(!strzICOLPathCustom.empty()) {
        ui->wallet_customzicolbackuppath->setText(QString::fromStdString(strzICOLPathCustom));
        ui->wallet_customzicolbackuppath_label->setVisible(true);
        ui->wallet_customzicolbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzICOLPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Icolcoin RPC console.") + "<br>" +
