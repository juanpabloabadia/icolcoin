...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Icolcoin Core icolcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  icolcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded icolcoin transaction") + "\n" +
                               "  icolcoin-tx [options] -create [commands]   " + _("Create hex-encoded icolcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded icolcoin transaction
