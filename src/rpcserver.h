...
/**
 * Icolcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzicolseed(const UniValue& params, bool fHelp);
extern UniValue getzicolseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzicol(const UniValue& params, bool fHelp);
extern UniValue dzicolstate(const UniValue& params, bool fHelp);
