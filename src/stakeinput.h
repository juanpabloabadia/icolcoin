...
#ifndef Icolcoin_STAKEINPUT_H
#define Icolcoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZICOL() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zICOLStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zicol, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZICOL() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZICOL() override { return false; }
};


#endif //Icolcoin_STAKEINPUT_H
