...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Icolcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Icolcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Icolcoin features */
        {"icolcoin", "masternode", &masternode, true, true, false},
        {"icolcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"icolcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"icolcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"icolcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"icolcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"icolcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"icolcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"icolcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"icolcoin", "startmasternode", &startmasternode, true, true, false},
        {"icolcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"icolcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"icolcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"icolcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"icolcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"icolcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"icolcoin", "mnbudget", &mnbudget, true, true, false},
        {"icolcoin", "preparebudget", &preparebudget, true, true, false},
        {"icolcoin", "submitbudget", &submitbudget, true, true, false},
        {"icolcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"icolcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"icolcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"icolcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"icolcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"icolcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"icolcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"icolcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"icolcoin", "mnsync", &mnsync, true, true, false},
        {"icolcoin", "spork", &spork, true, true, false},
        {"icolcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzicolseed", &getzicolseed, false, false, true},
        {"zerocoin", "setzicolseed", &setzicolseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzicol", &searchdzicol, false, false, true},
        {"zerocoin", "dzicolstate", &dzicolstate, false, false, true}
...
{
    return "> icolcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7573/\n";
}
