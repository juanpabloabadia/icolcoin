...
RESOURCES += src/qt/icolcoin.qrc src/qt/icolcoin_locale.qrc

TRANSLATIONS += src/qt/locale/icolcoin_bg.ts \
                src/qt/locale/icolcoin_de.ts \
                src/qt/locale/icolcoin_en.ts \
                src/qt/locale/icolcoin_es.ts \
                src/qt/locale/icolcoin_fi.ts \
                src/qt/locale/icolcoin_fr.ts \
                src/qt/locale/icolcoin_it.ts \
                src/qt/locale/icolcoin_ja.ts \
                src/qt/locale/icolcoin_pl.ts \
                src/qt/locale/icolcoin_pt.ts \
                src/qt/locale/icolcoin_ru.ts \
                src/qt/locale/icolcoin_sk.ts \
                src/qt/locale/icolcoin_sv.ts \
                src/qt/locale/icolcoin_vi.ts \
                src/qt/locale/icolcoin_zh_CN.ts \
                src/qt/locale/icolcoin_zh_TW.ts
