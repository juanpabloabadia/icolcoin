...
#   c) node1 mines 32 blocks, so now node 0 has 60001icol, node 1 has 4250icol, node2 has none.
#   d) node0 sends 601 icol to node2, in two transactions (301 icol, then 300 icol).
